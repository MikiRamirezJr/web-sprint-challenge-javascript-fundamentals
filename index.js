...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Nested functions can access the variable internal because it is in the scope of the parent function, myFunction(). Nested functions are able to access variables declared in the parent function, while external variables can only be accessed from the global scope.
